...
Separate File for Visualtisation of "corrected" Mortality
Resulting in Last column of Tab S4
Plot is not saved and not in the supplement
...
m_corr=(pop[12]-pop[3])/9   # 9 years between 2013 and 2022
pop_corr=(np.int32(pop[3]+m_corr*(jf-3))).astype(int)
# plt.plot(np.linspace(0,13,14),pop)
# plt.plot(np.linspace(0,13,14),pop_corr)
...
plt.plot(j,cmr,linestyle="--",lw=0.5,marker="o",color="salmon",
         label="Corrected MR in Germany, per 1000 people",
