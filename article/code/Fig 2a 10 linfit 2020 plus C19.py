...
c19tote=pd.read_csv('./C19 Todesfälle 2020-21 Wochen.txt',
                     delimiter="\s+")
# c19tote=pd.read_csv('../../RKI/Todesfälle/C19 Todesfälle 2020-21 Wochen.txt',
#                     delimiter="\s+")

c19tote=c19tote[c19tote["Sterbejahr"]==2020]
...
plt.savefig("../figures/Fig 2a de üs 2020 baseline 13-19 plus C19.png")
