...
#color="dodgerblue",
d_2021=tmp[tmp["Year"]==2021]["Total"].to_numpy()

plt.plot(np.linspace(1,52,52),d_2021,color="red",
         label="Reported Deaths 2021")
...
c19tote=c19tote[c19tote["Sterbejahr"]==2021]
...
plt.savefig("../figures/Fig 2b de üs 2021 baseline 13-19.png")
