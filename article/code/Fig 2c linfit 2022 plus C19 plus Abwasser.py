...
c19tote=pd.read_csv('../../data_proc/covid-deaths/C19 Todesfälle 2022 Wochen.txt')
...
abwasser=pd.read_csv("../../data_proc/wastewater/c19_2022_abwasser.csv")
...
plt.plot(abwasser["week"],abwasser["viruslast"]/100,
         label="COVID19 Wastewater Load by Amelag/RKI (÷100)",
